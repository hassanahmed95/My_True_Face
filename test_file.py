...
if __name__ == '__main__':
    ...
    json_file = "{base_path}/model.json".format(base_path=base_path)
    weights_file = "{base_path}/model_weights.h5".format(base_path= base_path)

    emotion_list = ["BORE", "INTERESTED", "NEUTRAL", "SURPRISE"]
    model = model_testing(json_file, weights_file)
    # pdb.set_trace()

    test_image = image.load_img("Updated_Data/train/Bore_faces/Bore9.jpg", target_size=(90, 90))
